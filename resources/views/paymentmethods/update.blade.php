    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateCowForm"
                    action="{{ route('paymentmethods.update', ['paymentmethods' => $medicine->id]) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="paymentMethod" class="form-control" value="{{ $medicine->name }}"
                            name="name">
                    </div>
