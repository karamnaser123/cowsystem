...
@section('body')
    <div class="card">
        <div class="card-header">ادارة الصلاحيات</div>
        <div class="card-body">
            @can('create-role')
                <a href="{{ route('roles.create') }}" class="btn btn-success btn-sm my-2"><i class="bi bi-plus-circle"></i> اضف
                    صلاحية جديدة</a>
            @endcan
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col" style="width: 250px;">احذف او عدل او اعرض</th>
                    </tr>
                </thead>
                <tbody>
