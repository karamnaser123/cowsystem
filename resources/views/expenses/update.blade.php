    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateCowForm" action="{{ route('expenses.update', ['expenses' => $medicine->id]) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $medicine->typeofexpense }}"
                            name="typeofexpense">
                    </div>

                    <div class="form-group">
                        <label> مقدار المصروف </label>
                        <input type="number" class="form-control" value="{{ $medicine->amount }}" name="amount">
                    </div>
