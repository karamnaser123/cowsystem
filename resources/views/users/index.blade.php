...
@section('body')
    ...
    <div class="card">
        <div class="card-header"> ادارة المستخدمين</div>
        <div class="card-body">
            @can('create-user')
                <a href="{{ route('users.create') }}" class="btn btn-success btn-sm my-2"><i class="bi bi-plus-circle"></i> اضف
                    مستخدم جديد</a>
            @endcan
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col">احذف او عدل او اعرض</th>
                    </tr>
                </thead>
                <tbody>
