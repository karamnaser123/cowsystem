            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('users.update', $user->id) }}" method="post">
                        ...
                        <div class="mb-3 row">
                            <label for="roles" class="col-md-4 col-form-label text-md-end text-start">نورع
                                المستخدم</label>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3 row">
                            <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="تعديل المستخدم">
                        </div>
